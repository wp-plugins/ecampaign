...
*/
  ...
  function initializeCannedFields()
  {
    $this->cannedFields = array(
      ...
      self::sVisitorName  => array(__('Name'),     "min=4  size=15"),
      self::sVisitorEmail => array(__('Email'),    "min=4  size=15", 'validateEmail'),
      self::sAddress1     => array(__('Address 1'),"min=4  size=15"),
      self::sAddress2     => array(__('Address 2'),"min=4  size=15"),
      self::sAddress3     => array(__('Address 3'),"min=4  size=15"),
